...
{{--            </g>--}}
{{--          </svg>--}}
            <img src="{{ asset('images/website/logo-babel-sm.png') }}"/>
          <h2 class="brand-text text-primary ml-1">babelprov.go.id</h2>
        </a>

{{--        <h4 class="card-title mb-1">Backend Babelprov.go.id👋</h4>--}}
