<div id="artikel">
    ...
    <div class="card mt-1 mb-50">
        ...
        <div class="card-header bg-success bg-darken-2 text-white p-1 m-0">
            <h4 class="card-title text-white">:: Transparansi Anggaran</h4>
            <p class="card-text font-small-2 mr-25 mb-0">
                <a href="https://babelprov.go.id/publikasi?fltrKategori=Transparansi+Anggaran&fltrSubKategori=&fltrTahun=" class="text-body-heading">
                    + Transparansi Anggaran Lainnya
                </a>
            </p>
        </div>
...
{{--            </div>--}}
                ...
                <div class="d-flex justify-content-between flex-column col-12 col-md-12 order-2 order-md-2 p-0">
                    <div class="media-list media-bordered px-50">
                        ...
                        @foreach(array_slice($data_artikel, 0, 5) as $item_artikel)
