    ...
    <div class="card mt-1">
        ...
        <div class="card-body my-50 py-50">
            <div class="row">
                ...
                <!-- Kabar Lainnya -->
                <div class="d-flex justify-content-between flex-column col-12 col-md-8 order-2 order-md-2 p-0">
                        ...
                        @foreach(array_slice($data_artikel, 1, 5) as $item_artikel)
                            <div class="media p-50">
                                <div class="media-aside align-self-start pr-1">
                                    <img src="{{ $item_artikel['thumb_foto'] }}" width="100" height="60" class="rounded" alt="{{ $item_artikel['title'] }}">
                                </div>
